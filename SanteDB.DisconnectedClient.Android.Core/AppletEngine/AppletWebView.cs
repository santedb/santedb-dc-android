...
namespace SanteDB.DisconnectedClient.Android.Core.AppletEngine
{
	/// <summary>
	...
	public sealed class AppletWebView : WebView
	{
		...
		private class AppletWebViewClient : WebViewClient
		{
			...
			/// <see cref="SanteDB.DisconnectedClient.Android.Core.AppletEngine.AppletWebView+AppletWebViewClient"/> class.
			/// </summary>
		...
		private class AppletWebChromeClient : WebChromeClient
		{
			...
			/// <summary>
			/// Initializes a new instance of the
			/// <see cref="SanteDB.DisconnectedClient.Android.Core.AppletEngine.AppletWebView+AppletWebChromeClient"/> class.
			/// </summary>
			/// <param name="context">Context.</param>
